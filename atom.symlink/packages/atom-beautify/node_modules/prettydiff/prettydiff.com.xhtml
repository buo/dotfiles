...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="white" id="webtool">
        ...
        <div id="reports">
            ...
            <div class="box" id="feedreport" role="dialog_nonmodal">
                ...
                <p class="buttons" style="display:none">
                    ...
                    <button class="resize" title="Resize this dialogue.">&harr;</button>
                </p>
        ...
        <div class="options" id="options" role="toolbar">
            ...
            <p>
                <strong>Line Termination
                    <a href="documentation.xhtml#crlf">(crlf)</a>
                </strong>
                <span>
                    <input checked="checked" id="lterminator-lf" name="lterminator"
                        title="Terminate line of output with LF for compatibility with Unix and Linux based systems."
                        type="radio"/>
                    <label for="lterminator-lf">Unix Style (LF)</label>
                </span>
                <span>
                    <input id="lterminator-crlf" name="lterminator"
                        title="Terminate lines of output with CRLF for compatibility with Windows."
                        type="radio"/>
                    <label for="lterminator-crlf">Windows Style (CRLF)</label>
                </span>
            </p>
            <p>
            ...
            <div class="options" id="diffops">
                    ...
                    <p>
                        ...
                        <span>
                            <input id="diff-save"
                                ...
                                type="checkbox"/>
                            <label for="diff-save">&mdash; Generates HTML report as raw text inside a text area.</label>
                        </span>
                    </p>
                    <p>
                        ...
                        <span>
                            <input id="contextSize"
                                ...
                                type="text" value=""/>
                            <label for="contextSize">&mdash; This sets number of matching lines of code to pad the differences.</label>
                        </span>
                    </p>
                    <p>
                ...
                <fieldset id="diffbeautify">
                    ...
                    <fieldset>
                        ...
                        <p>
                            <strong>Comma Separated Selector Lists
                                <a class="apiname" href="documentation.xhtml#selectorlist">(selectorlist)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="dselectorlist-no" name="dselectorlist"
                                    title="Breaks comma separated lists of selectors onto multiple lines."
                                    type="radio"/>
                                <label for="dselectorlist-no">Broken into new lines</label>
                            </span>
                            <span>
                                <input id="dselectorlist-yes" name="dselectorlist"
                                    title="Keeps lists of selectors on a single line of code." type="radio"/>
                                <label for="dselectorlist-yes">Retain on a single line</label>
                            </span>
                        </p>
                    </fieldset>
                    <fieldset>
                        ...
                        <p>
                            <strong>Dust.js Template
                                <a class="apiname" href="documentation.xhtml#dustjs">(dustjs)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="ddustno" name="ddust"
                                    title="Do not interpret the markup code as a Dust.js template" type="radio"/>
                                <label for="ddustno">Not a Dust.js template</label>
                            </span>
                            <span>
                                <input id="ddustyes" name="ddust"
                                    title="Interpret the markup code as a Dust.js template" type="radio"/>
                        ...
                        <p>
                            ...
                            <span>
                                <input id="dtagsort-yes" name="dtagsort" title="Sort markup code." type="radio"/>
                                <label for="dtagsort-yes">Sort markup pieces</label>
                            </span>
                        </p>
                        <p>
                            <strong>Preserve Text Content
                                <a class="apiname" href="documentation.xhtml#textpreserve">(textpreserve)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="dtextpreserveno" name="dtextpreserve"
                                    title="Do not literally preserve white space in text." type="radio"/>
                                <label for="dtextpreserveno">Beautify text content</label>
                            </span>
                            <span>
                                <input id="dtextpreserveyes" name="dtextpreserve"
                                    title="Preserve all white space in text content exactly as supplied."
                                    type="radio"/>
                    ...
                    <fieldset>
                        ...
                        <p>
                            ...
                            <span>
                                ...
                                <label for="dbraceline-yes">Pad JavaScript blocks with empty lines</label>
                            </span>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <span>
                                <input id="jsindentd-all" name="jsindentdiff"
                                    ...
                                    type="radio"/>
                                <label for="jsindentd-all">Allman (ANSI) style &mdash; sets opening curly braces on a new line.</label>
                            </span>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            <span>
                                <input checked="checked" id="dmethodchain-no" name="dmethodchain"
                                    title="Indent a run of methods." type="radio"/>
                                <label for="dmethodchain-no">Indent a run of methods</label>
                            </span>
                            <span>
                                <input id="dmethodchain-yes" name="dmethodchain"
                                    title="Chain methods onto a single line." type="radio"/>
                                <label for="dmethodchain-yes">Chain methods onto a single line</label>
                            </span>
                        </p>
                        <p>
                            <strong>Case Indentation
                                <a class="apiname" href="documentation.xhtml#nocaseindent">(nocaseindent)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="dnocaseindent-no" name="dnocaseindent"
                                    title="Indent cases in switch blocks" type="radio"/>
                                <label for="dnocaseindent-no">Indent case statements</label>
                            </span>
                            <span>
                                <input id="dnocaseindent-yes" name="dnocaseindent"
                                    title="Do not indent cases in switch blocks." type="radio"/>
                                <label for="dnocaseindent-yes">Do not indent cases in switch blocks</label>
                            </span>
                        </p>
                        <p>
            ...
            <div class="options" id="beauops" style="display:none;">
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <p>
                            <strong>Quotes
                                <a class="apiname" href="documentation.xhtml#quoteconvert">(quoteconvert)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bquoteconvert-none" name="bquoteconvert"
                                    title="Do not convert quote characters." type="radio"/>
                                <label for="bquoteconvert-none">Leave the quotes alone</label>
                            </span>
                            <span>
                                <input id="bquoteconvert-double" name="bquoteconvert"
                                    title="Convert double quotes to single quotes for JavaScript strings and markup attributes."
                                    type="radio"/>
                                <label for="bquoteconvert-double">Convert to double quotes</label>
                            </span>
                            <span>
                                <input id="bquoteconvert-single" name="bquoteconvert"
                                    title="Convert single quotes to double quotes for JavaScript strings and markup attributes."
                                    type="radio"/>
                                <label for="bquoteconvert-single">Convert to single quotes</label>
                            </span>
                        </p>
                </fieldset>
                <fieldset>
                    ...
                    <fieldset>
                        <legend>Multiformat Options</legend>
                        <p>
                            <strong>Fix Sloppy Code, Markup / JavaScript
                                <a class="apiname" href="documentation.xhtml#correct">(correct)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="jscorrect-no" name="jscorrect"
                                    title="Do not alter or remove sloppy JavaScript code or correct for missing end list item tags in HTML."
                                    type="radio"/>
                                <label for="jscorrect-no">Ignore code correction</label>
                            </span>
                            <span>
                                <input id="jscorrect-yes" name="jscorrect"
                                    title="This JavaScript only option automatically converts some sloppy behaviors into known best practices."
                                    type="radio"/>
                                <label for="jscorrect-yes">Correct for sloppiness</label>
                            </span>
                            <span>Read the
                        ...
                        <p>
                            ...
                            <span>
                                <input checked="checked" id="bobjsort-jsonly" name="bobjsort"
                                    title="Sort JavaScript object properties alphabetically by key name."
                                    type="radio"/>
                                <label for="bobjsort-jsonly">Sort JavaScript objects</label>
                            </span>
                            <span>
                                <input id="bobjsort-cssonly" name="bobjsort"
                                    title="Sort CSS properties alphabetically by property name." type="radio"/>
                                <label for="bobjsort-cssonly">Sort CSS properties</label>
                            </span>
                            <span>
                                <input id="bobjsort-all" name="bobjsort"
                                    title="Sort CSS properties and JavaScript object properties alphabetically by key/property name."
                                    type="radio"/>
                                <label for="bobjsort-all">Sort by key/property</label>
                            </span>
                            <span>
                                <input id="bobjsort-none" name="bobjsort"
                                    title="Turn sorting off for CSS and JavaScript." type="radio"/>
                                <label for="bobjsort-none">Do not sort</label>
                            </span>
                        </p>
                        <p>
                            <strong>Vertically Align, CSS / JavaScript
                                <a class="apiname" href="documentation.xhtml#vertical">(vertical)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="vertical-jsonly" name="vertical"
                                    title="This option provides vertical alignment of assignments only to JavaScript and not CSS like languages."
                                    type="radio"/>
                                <label for="vertical-jsonly">Vertically align JavaScript</label>
                            </span>
                            <span>
                                <input id="vertical-cssonly" name="vertical"
                                    title="This option causes lists of CSS properties to be vertically aligned for faster reading."
                                    type="radio"/>
                                <label for="vertical-cssonly">Vertically align CSS</label>
                            </span>
                            <span>
                                <input id="vertical-all" name="vertical"
                                    title="This option pads property names in JavaScript and CSS like languages so that their values are vertically aligned."
                                    type="radio"/>
                                <label for="vertical-all">Vertically align CSS/JS</label>
                            </span>
                            <span>
                                <input id="vertical-none" name="vertical"
                                    title="This option prevents padding of variable and property names for vertical alignment in all languages."
                                    type="radio"/>
                                <label for="vertical-none">Do not vertical align</label>
                            </span>
                        </p>
                        <p>
                            <label class="label" for="beau-wrap">Wrap text, Markup / JavaScript
                                <a class="apiname" href="documentation.xhtml#wrap">(wrap)</a>
                            </label>
                            <span>
                                <input id="beau-wrap"
                    ...
                    <fieldset>
                        <legend>CSS Options</legend>
                        <p>
                            <strong>Insert Extra Lines
                                <a class="apiname" href="documentation.xhtml#cssinsertlines">(cssinsertlines)</a>
                            </strong>
                            <span><input checked="checked" id="cssinsertlines-no" name="cssinsertlines"
                                title="Do not insert new lines between CSS blocks." type="radio"/>
                                <label for="cssinsertlines-no">Do not create empty lines.</label>
                            </span>
                            <span><input id="cssinsertlines-yes" name="cssinsertlines"
                                title="Insert empty lines between CSS blocks." type="radio"/>
                                <label for="cssinsertlines-yes">Insert a new line character between each CSS block.</label>
                            </span>
                        </p>
                        <p>
                            <strong>Leading 0s
                                <a class="apiname" href="documentation.xhtml#noleadzero">(noleadzero)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bnoleadzero-no" name="bnoleadzero"
                                    title="Retain or add leading 0s of values immediately before a decimal."
                                    type="radio"/>
                                <label for="bnoleadzero-no">Retain/add leading 0s</label>
                            </span>
                            <span>
                                <input id="bnoleadzero-yes" name="bnoleadzero"
                                    title="Remove or prevent leading 0s of values immediately before a decimal."
                                    type="radio"/>
                                <label for="bnoleadzero-yes">Remove/prevent leading 0s</label>
                            </span>
                        </p>
                        <p>
                            <strong>Comma Separated Selector Lists
                            ...
                            <span>
                                <input checked="checked" id="bselectorlist-no" name="bselectorlist"
                                    title="Breaks comma separated lists of selectors onto multiple lines."
                                    type="radio"/>
                                <label for="bselectorlist-no">Broken into new lines</label>
                            </span>
                            <span>
                                <input id="bselectorlist-yes" name="bselectorlist"
                                    title="Keeps lists of selectors on a single line of code." type="radio"/>
                                <label for="bselectorlist-yes">Retain on a single line</label>
                            </span>
                        </p>
                    </fieldset>
                    <fieldset>
                        <legend>Markup Options</legend>
                        <p>
                            <strong>Force an Empty Line Above Comments
                                <a class="apiname" href="documentation.xhtml#commline">(commline)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bcommline-no" name="bcommline"
                                    title="Do not force new lines above comments." type="radio"/>
                                <label for="bcommline-no">No extra empty lines</label>
                            </span>
                            <span>
                                <input id="bcommline-yes" name="bcommline"
                                    title="Force new lines above comments." type="radio"/>
                                <label for="bcommline-yes">Force new lines above comments</label>
                            </span>
                        </p>
                        <p>
                            <strong>Dust.js Template
                            ...
                            <span>
                                <input checked="checked" id="bdustno" name="bdust"
                                    title="Do not interpret the markup code as a Dust.js template" type="radio"/>
                                <label for="bdustno">Not a Dust.js template</label>
                            </span>
                            <span>
                                <input id="bdustyes" name="bdust"
                                    title="Interpret the markup code as a Dust.js template" type="radio"/>
                                <label for="bdustyes">Dust.js template</label>
                            </span>
                        </p>
                        <p>
                            <strong>Force Indentation
                            ...
                            <span>
                                <input checked="checked" id="bforce_indent-no" name="bforce_indent"
                                    title="This markup only option maintains document integrity with regard to indentation that would create text nodes adjacent to content that did not exist before."
                                    type="radio"/>
                                <label for="bforce_indent-no">Maintain code integrity</label>
                            </span>
                            <span>
                                <input id="bforce_indent-yes" name="bforce_indent"
                                    title="This markup only option forces indentation for all content and elements without regard for integrity of document structure or content."
                                    type="radio"/>
                                <label for="bforce_indent-yes">Always force indentation</label>
                            </span>
                        </p>
                        <p>
                            <strong>Presume HTML
                            ...
                            <span>
                                <input checked="checked" id="html-yes" name="presumehtml"
                                    title="This option determines whether HTML tags like &lt;br&gt; and lt;hr&gt; should be evaluated as singletons, such as &lt;br/&gt; and lt;hr/&gt;."
                                    type="radio"/>
                                <label for="html-yes">Tolerate HTML sillyness</label>
                            </span>
                            <span>
                                <input id="html-no" name="presumehtml"
                                    title="Use this option to ignore HTML specific vocabulary and instead focus purely on syntax."
                                    type="radio"/>
                                <label for="html-no">Strict XML syntax</label>
                            </span>
                        </p>
                        <p>
                            <strong>End Self-Closing Tags with a Space
                                <a class="apiname" href="documentation.xhtml#spaceclose">(spaceclose)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bspaceclose-no" name="bspaceclose"
                                    title="End self-closing tags with no space '/&gt;'." type="radio"/>
                                <label for="bspaceclose-no">No extra space</label>
                            </span>
                            <span>
                                <input id="bspaceclose-yes" name="bspaceclose"
                                    title="End self-closing tags with a space, ' /&gt;'." type="radio"/>
                                <label for="bspaceclose-yes">End self-closing tags with a space, ' /&gt;'</label>
                            </span>
                        </p>
                        <p>
                            <strong>Indent Style/Script
                            ...
                            <span>
                                <input checked="checked" id="inscript-yes" name="inscript"
                                    title="This markup only option sets the baseline for script and style definition from the identation point of the opening markup tag plus one indentation step."
                                    type="radio"/>
                                <label for="inscript-yes">Indent to markup</label>
                            </span>
                            <span>
                                <input id="inscript-no" name="inscript"
                                    title="This option sets the indentation baseline for script and style code to 0 regardless of surrounding markup."
                                    type="radio"/>
                                <label for="inscript-no">Indent script/style independently</label>
                            </span>
                        </p>
                        <p>
                            <strong>Merge Empty Tag Sets Into A Single Self-Closing Tag
                            ...
                            <span>
                                <input checked="checked" id="btagmerge-no" name="btagmerge"
                                    title="Do not automatically merge start and end tags of the same name."
                                    type="radio"/>
                                <label for="btagmerge-no">Do not merge tags</label>
                            </span>
                            <span>
                                <input id="btagmerge-yes" name="btagmerge"
                                    title="Automatically merge immediately adjacent start and end tags of the same name."
                                    type="radio"/>
                                <label for="btagmerge-yes">Merge tags</label>
                            </span>
                        </p>
                        <p>
                            <strong>Sort Child Items of Each Parent Element
                            ...
                            <span>
                                <input checked="checked" id="btagsort-no" name="btagsort"
                                    title="Do not rearrange markup code." type="radio"/>
                                <label for="btagsort-no">Do not sort markup code</label>
                            </span>
                            <span>
                                <input id="btagsort-yes" name="btagsort" title="Sort markup code." type="radio"/>
                                <label for="btagsort-yes">Sort markup pieces</label>
                            </span>
                        </p>
                        <p>
                            <strong>Preserve Text Content
                            ...
                            <span>
                                <input checked="checked" id="btextpreserveno" name="btextpreserve"
                                    title="Do not literally preserve white space in text." type="radio"/>
                                <label for="btextpreserveno">Beautify text content</label>
                            </span>
                            <span>
                                <input id="btextpreserveyes" name="btextpreserve"
                                    title="Preserve all white space in text content exactly as supplied."
                                    type="radio"/>
                                <label for="btextpreserveyes">Preserve white space in text</label>
                            </span>
                        </p>
                    </fieldset>
                    <fieldset>
                        ...
                        <p>
                            ...
                            <span>
                                <input checked="checked" id="bbraceline-no" name="bbraceline"
                                    title="In JavaScript do not pad blocks with empty lines." type="radio"/>
                                <label for="bbraceline-no">Normal blocks</label>
                            </span>
                            <span>
                                <input id="bbraceline-yes" name="bbraceline"
                                    title="In JavaScript pad blocks with empty lines." type="radio"/>
                                <label for="bbraceline-yes">Pad JavaScript blocks with empty lines</label>
                            </span>
                        </p>
                        <p>
                            <strong>Brace Padding
                            ...
                            <span>
                                <input checked="checked" id="bracepadding-no" name="bracepadding"
                                    title="This option does not pad braces in JavaScript with spaces." type="radio"/>
                                <label for="bracepadding-no">No brace padding</label>
                            </span>
                            <span>
                                <input id="bracepadding-yes" name="bracepadding"
                                    title="Inserts a space after the start of a contain and before the end of the container in JavaScript if the contents of that container are not indented; such as: conditions, function arguments, and escaped sequences of template strings."
                                    type="radio"/>
                                <label for="bracepadding-yes">Pads container characters from their contents.</label>
                            </span>
                        </p>
                        <p>
                            <strong>Style of Indent
                            ...
                            <span>
                                <input checked="checked" id="jsindent-knr" name="jsindent"
                                    title="This JavaScript only option sets opening curly braces at the end of the current line of code."
                                    type="radio"/>
                                <label for="jsindent-knr">K&amp;R style</label>
                            </span>
                            <span>
                                <input id="jsindent-all" name="jsindent"
                                    title="This JavaScript only option moves opening curly braces onto a new line for visibility of brace contents apart from other code."
                                    type="radio"/>
                                <label for="jsindent-all">Allman (ANSI) style &mdash; sets opening curly braces on a new line.</label>
                            </span>
                        </p>
                        <p>
                            <strong>Else on New Line
                            ...
                            <span>
                                <input checked="checked" id="jselseline-no" name="jselseline"
                                    title="This JavaScript only option will precede the 'else' keyword with a space."
                                    type="radio"/>
                                <label for="jselseline-no">A space precedes 'else'</label>
                            </span>
                            <span>
                                <input id="jselseline-yes" name="jselseline"
                                    title="This JavaScript only option will force the 'else' keyword onto a new line."
                                    type="radio"/>
                                <label for="jselseline-yes">Force 'else' keyword onto a new line</label>
                            </span>
                        </p>
                        <p>
                            <strong>Trailing Commas
                                <a class="apiname" href="documentation.xhtml#endcomma">(endcomma)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bendcomma-no" name="bendcomma"
                                    title="Removes trailing commas from arrays and object literals." type="radio"/>
                                <label for="bendcomma-no">Remove trailing commas</label>
                            </span>
                            <span>
                                <input id="bendcomma-yes" name="bendcomma"
                                    title="Adds trailing commas to arrays and object literals." type="radio"/>
                                <label for="bendcomma-yes">Add trailing commas</label>
                            </span>
                        </p>
                        <p>
                            <strong>Scope Analysis
                                <a class="apiname" href="documentation.xhtml#jsscope">(jsscope)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="jsscope-no" name="jsscope"
                                    title="This option will causes standard text beautification for JavaScript"
                                    type="radio"/>
                                <label for="jsscope-no">Standard beautification</label>
                            </span>
                            <span>
                                <input id="jsscope-yes" name="jsscope"
                                    title="This option will display a colorful HTML output of the code that color codes variables to the scope they are declared so as to illustrate the nature of closure and inheritance."
                                    type="radio"/>
                                <label for="jsscope-yes">Scope analysis report</label>
                            </span>
                            <span>
                                <input id="jsscope-html" name="jsscope"
                                    title="This option outputs HTML so that a colorful code snippet is created for use in web pages."
                                    type="radio"/>
                                <label for="jsscope-html">HTML output</label>
                            </span>
                            <span>Read about
                        ...
                        <p>
                            ...
                            <span>
                                <input checked="checked" id="bmethodchain-no" name="bmethodchain"
                                    title="Indent a run of methods." type="radio"/>
                                <label for="bmethodchain-no">Indent a run of methods</label>
                            </span>
                            <span>
                                <input id="bmethodchain-yes" name="bmethodchain"
                                    title="Chain methods onto a single line." type="radio"/>
                                <label for="bmethodchain-yes">Chain methods onto a single line</label>
                            </span>
                        </p>
                        <p>
                            <strong>Case Indentation
                            ...
                            <span>
                                <input checked="checked" id="bnocaseindent-no" name="bnocaseindent"
                                    title="Indent cases in switch blocks" type="radio"/>
                                <label for="bnocaseindent-no">Indent case statements</label>
                            </span>
                            <span>
                                <input id="bnocaseindent-yes" name="bnocaseindent"
                                    title="Do not indent cases in switch blocks." type="radio"/>
                                <label for="bnocaseindent-yes">Do not indent cases in switch blocks</label>
                            </span>
                        </p>
                        <p>
                            <strong>Function Space
                            ...
                            <span>
                                <input checked="checked" id="jsspace-yes" name="jsspace"
                                    title="This JavaScript only option retains a single space between the 'function' keyword and the opening parenthesis character of anonymous functions."
                                    type="radio"/>
                                <label for="jsspace-yes">Retain function space</label>
                            </span>
                            <span>
                                <input id="jsspace-no" name="jsspace"
                                    title="This JavaScript only option removes a single space between the 'function' keyword and the opening parenthesis character of anonymous functions."
                                    type="radio"/>
                                <label for="jsspace-no">Remove space following function</label>
                            </span>
                        </p>
                        <p>
                            <label class="label" for="bstyleguide">Style Guide
                                <a class="apiname" href="documentation.xhtml#styleguide">(styleguide)</a>
                            </label>
                            <select id="bstyleguide">
                                ...
                                <option value="jslint">JSLint</option>
                            ...
                            <span>Read about
                                <a href="guide/styleguide.xhtml">style guide support</a>
                            </span>
                        </p>
                        <p>
                            <strong>Variable Lists
                                <a class="apiname" href="documentation.xhtml#varword">(varword)</a>
                            </strong>
                            <span>
                                <input checked="checked" id="bvarword-none" name="bvarword"
                                    title="Ignore this option." type="radio"/>
                                <label for="bvarword-none">Leave the variables alone</label>
                            </span>
                            <span>
                                <input id="bvarword-list" name="bvarword"
                                    title="In JavaScript change consecutive variable declarations into a comma separated list with a single var keyword."
                                    type="radio"/>
                                <label for="bvarword-list">Comma separated list</label>
                            </span>
                            <span>
                                <input id="bvarword-each" name="bvarword"
                                    title="In JavaScript change a comma separated list of variables into individual statements each starting with a var keyword."
                                    type="radio"/>
                                <label for="bvarword-each">Separate variables</label>
                            </span>
                        </p>
                    </fieldset>
                </fieldset>
            </div>
            <div class="options" id="miniops" style="display:none;">
                <h2>Minify Options</h2>
                <p class="apiname">(API name in parenthesis)</p>
                <fieldset>
                    <legend>Multifunction Options</legend>
                    <p>
                        <strong>Property Sorting, CSS / JavaScript
                            <a class="apiname" href="documentation.xhtml#objsort">(objsort)</a>
                        </strong>
                        <span>
                            <input checked="checked" id="mobjsort-jsonly" name="mobjsort"
                                title="Sort JavaScript object properties alphabetically by key name."
                                type="radio"/>
                            <label for="mobjsort-jsonly">Sort JavaScript objects</label>
                        </span>
                        <span>
                            <input id="mobjsort-cssonly" name="mobjsort"
                                title="Sort CSS properties alphabetically by property name." type="radio"/>
                            <label for="mobjsort-cssonly">Sort CSS properties</label>
                        </span>
                        <span>
                            <input id="mobjsort-all" name="mobjsort"
                                title="Sort CSS properties and JavaScript object properties alphabetically by key/property name."
                                type="radio"/>
                            <label for="mobjsort-all">Sort by key/property</label>
                        </span>
                        <span>
                            <input id="mobjsort-none" name="mobjsort"
                                title="Turn sorting off for CSS and JavaScript." type="radio"/>
                            <label for="mobjsort-none">Do not sort</label>
                        </span>
                    </p>
                    <p>
                        <strong>Quotes, Markup / JavaScript
                            <a class="apiname" href="documentation.xhtml#quoteconvert">(quoteconvert)</a>
                        </strong>
                        <span>
                            <input checked="checked" id="mquoteconvert-double" name="mquoteconvert"
                                title="Convert double quotes to single quotes for JavaScript strings and markup attributes."
                                type="radio"/>
                            <label for="mquoteconvert-double">Convert to double quotes</label>
                        </span>
                        <span>
                            <input id="mquoteconvert-single" name="mquoteconvert"
                                title="Convert single quotes to double quotes for JavaScript strings and markup attributes."
                                type="radio"/>
                            <label for="mquoteconvert-single">Convert to single quotes</label>
                        </span>
                        <span>
                            <input id="mquoteconvert-none" name="mquoteconvert"
                                title="Do not convert quote characters." type="radio"/>
                            <label for="mquoteconvert-none">Leave the quotes alone</label>
                        </span>
                    </p>
                    <p>
                        <strong>Top Comments, CSS / JavaScript
                            <a class="apiname" href="documentation.xhtml#topcoms">(topcoms)</a>
                        </strong>
                        <span>
                            <input checked="checked" id="topcoms-no" name="topcoms"
                                title="Use this remove all comments in JavaScript and CSS including comments above the first line of code."
                                type="radio"/>
                            <label for="topcoms-no">Minify all comments</label>
                        </span>
                        <span>
                            <input id="topcoms-yes" name="topcoms"
                                title="Use this option retain comments comments above the first line of JavaScript and CSS code."
                                type="radio"/>
                            <label for="topcoms-yes">Preserve comments before any code</label>
                        </span>
                    </p>
                </fieldset>
                <fieldset>
                    ...
                    <p>
                        ...
                        <span>
                            <input checked="checked" id="conditionalm-no" name="conditionalm"
                                title="Use this option to remove HTML contitional comments used by Internet Explorer."
                                type="radio"/>
                            <label for="conditionalm-no">Remove all comments</label>
                        </span>
                        <span>
                            <input id="conditionalm-yes" name="conditionalm"
                                title="Use this option to keep HTML contitional comments used by Internet Explorer."
                                type="radio"/>
                            <label for="conditionalm-yes">Preserve HTML conditional comments</label>
                        </span>
                    </p>
                    <p>
                        <strong>Dust.js Template
                        ...
                        <span>
                            <input checked="checked" id="mdustno" name="mdust"
                                title="Do not interpret the markup code as a Dust.js template" type="radio"/>
                            <label for="mdustno">Not a Dust.js template</label>
                        </span>
                        <span>
                            <input id="mdustyes" name="mdust"
                                title="Interpret the markup code as a Dust.js template" type="radio"/>
                            <label for="mdustyes">Dust.js template</label>
                        </span>
                    </p>
                    <p>
                        <strong>Presume HTML
                        ...
                        <span>
                            <input checked="checked" id="htmlm-yes" name="presumehtmlm"
                                title="This option determines whether HTML tags like &lt;br&gt; and lt;hr&gt; should be evaluated as singletons, such as &lt;br/&gt; and lt;hr/&gt;."
                                type="radio"/>
                            <label for="htmlm-yes">Tolerate HTML sillyness</label>
                        </span>
                        <span>
                            <input id="htmlm-no" name="presumehtmlm"
                                title="Use this option to ignore HTML specific vocabulary and instead focus purely on syntax."
                                type="radio"/>
                            <label for="htmlm-no">Strict XML syntax</label>
                        </span>
                    </p>
                    <p>
                        <strong>Merge Empty Tag Sets Into A Single Self-Closing Tag
                        ...
                        <span>
                            <input checked="checked" id="mtagmerge-no" name="mtagmerge"
                                title="Do not automatically merge start and end tags of the same name."
                                type="radio"/>
                            <label for="mtagmerge-no">Do not merge tags</label>
                        </span>
                        <span>
                            <input id="mtagmerge-yes" name="mtagmerge"
                                title="Automatically merge immediately adjacent start and end tags of the same name."
                                type="radio"/>
                            <label for="mtagmerge-yes">Merge tags</label>
                        </span>
                    </p>
                    <p>
                        <strong>Sort Child Items of Each Parent Element
                        ...
                        <span>
                            <input checked="checked" id="mtagsort-no" name="mtagsort"
                                title="Do not rearrange markup code." type="radio"/>
                            <label for="mtagsort-no">Do not sort markup code</label>
                        </span>
                        <span>
                            <input id="mtagsort-yes" name="mtagsort" title="Sort markup code." type="radio"/>
                            <label for="mtagsort-yes">Sort markup pieces</label>
                        </span>
                    </p>
                    <p>
                        <strong>Preserve Text Content
                        ...
                        <span>
                            <input checked="checked" id="mtextpreserveno" name="mtextpreserve"
                                title="Do not literally preserve white space in text." type="radio"/>
                            <label for="mtextpreserveno">Beautify text content</label>
                        </span>
                        <span>
                            <input id="mtextpreserveyes" name="mtextpreserve"
                                title="Preserve all white space in text content exactly as supplied."
                                type="radio"/>
                            <label for="mtextpreserveyes">Preserve white space in text</label>
                        </span>
                    </p>
                </fieldset>
            </div>
            <div class="options" id="parseops" style="display:none;">
                <h2>Parse Options</h2>
                <p class="apiname">(API name in parenthesis)</p>
                <fieldset>
                    <legend>Multifunction Options</legend>
                    <p>
                        ...
                        <span>
                            <input checked="checked" id="pobjsort-jsonly" name="pobjsort"
                                title="Sort JavaScript object properties alphabetically by key name."
                                type="radio"/>
                            <label for="pobjsort-jsonly">Sort JavaScript objects</label>
                        </span>
                        <span>
                            <input id="pobjsort-cssonly" name="pobjsort"
                                title="Sort CSS properties alphabetically by property name." type="radio"/>
                            <label for="pobjsort-cssonly">Sort CSS properties</label>
                        </span>
                        <span>
                            <input id="pobjsort-all" name="pobjsort"
                                title="Sort CSS properties and JavaScript object properties alphabetically by key/property name."
                                type="radio"/>
                            <label for="pobjsort-all">Sort by key/property</label>
                        </span>
                        <span>
                            <input id="pobjsort-none" name="pobjsort"
                                title="Turn sorting off for CSS and JavaScript." type="radio"/>
                            <label for="pobjsort-none">Do not sort</label>
                        </span>
                    </p>
                    <p>
                        <strong>Quotes, Markup / JavaScript
                        ...
                        <span>
                            <input checked="checked" id="pquoteconvert-none" name="pquoteconvert"
                                title="Do not convert quote characters." type="radio"/>
                            <label for="pquoteconvert-none">Leave the quotes alone</label>
                        </span>
                        <span>
                            <input id="pquoteconvert-double" name="pquoteconvert"
                                title="Convert double quotes to single quotes for JavaScript strings and markup attributes."
                                type="radio"/>
                            <label for="pquoteconvert-double">Convert to double quotes</label>
                        </span>
                        <span>
                            <input id="pquoteconvert-single" name="pquoteconvert"
                                title="Convert single quotes to double quotes for JavaScript strings and markup attributes."
                                type="radio"/>
                            <label for="pquoteconvert-single">Convert to single quotes</label>
                        </span>
                    </p>
                </fieldset>
                <fieldset>
                    ...
                    <p>
                        ...
                        <span>
                            <input checked="checked" id="pdustno" name="pdust"
                                title="Do not interpret the markup code as a Dust.js template" type="radio"/>
                            <label for="pdustno">Not a Dust.js template</label>
                        </span>
                        <span>
                            <input id="pdustyes" name="pdust"
                                title="Interpret the markup code as a Dust.js template" type="radio"/>
                            <label for="pdustyes">Dust.js template</label>
                        </span>
                    </p>
                    <p>
                        <strong>Presume HTML
                        ...
                        <span>
                            <input checked="checked" id="phtml-yes" name="ppresumehtml"
                                title="This option determines whether HTML tags like &lt;br&gt; and lt;hr&gt; should be evaluated as singletons, such as &lt;br/&gt; and lt;hr/&gt;."
                                type="radio"/>
                            <label for="phtml-yes">Tolerate HTML sillyness</label>
                        </span>
                        <span>
                            <input id="phtml-no" name="ppresumehtml"
                                title="Use this option to ignore HTML specific vocabulary and instead focus purely on syntax."
                                type="radio"/>
                            <label for="phtml-no">Strict XML syntax</label>
                        </span>
                    </p>
                    <p>
                        <strong>Merge Empty Tag Sets Into A Single Self-Closing Tag
                        ...
                        <span>
                            <input checked="checked" id="ptagmerge-no" name="ptagmerge"
                                title="Do not automatically merge start and end tags of the same name."
                                type="radio"/>
                            <label for="ptagmerge-no">Do not merge tags</label>
                        </span>
                        <span>
                            <input id="ptagmerge-yes" name="ptagmerge"
                                title="Automatically merge immediately adjacent start and end tags of the same name."
                                type="radio"/>
                            <label for="ptagmerge-yes">Merge tags</label>
                        </span>
                    </p>
                    <p>
                        <strong>Sort Child Items of Each Parent Element
                        ...
                        <span>
                            <input checked="checked" id="ptagsort-no" name="ptagsort"
                                title="Do not rearrange markup code." type="radio"/>
                            <label for="ptagsort-no">Do not sort markup code</label>
                        </span>
                        <span>
                            <input id="ptagsort-yes" name="ptagsort" title="Sort markup code." type="radio"/>
                            <label for="ptagsort-yes">Sort markup pieces</label>
                        </span>
                    </p>
                    <p>
                        <strong>Preserve Text Content
                        ...
                        <span>
                            <input checked="checked" id="ptextpreserveno" name="ptextpreserve"
                                title="Do not literally preserve white space in text." type="radio"/>
                            <label for="ptextpreserveno">Beautify text content</label>
                        </span>
                        <span>
                            <input id="ptextpreserveyes" name="ptextpreserve"
                                title="Preserve all white space in text content exactly as supplied."
                                type="radio"/>
                            <label for="ptextpreserveyes">Preserve white space in text</label>
                        </span>
                    </p>
                </fieldset>
                <fieldset>
                    ...
                    <p>
                        ...
                        <span>
                            <input checked="checked" id="pvarword-none" name="pvarword"
                                title="Ignore this option." type="radio"/>
                            <label for="pvarword-none">Leave the variables alone</label>
                        </span>
                        <span>
                            <input id="pvarword-list" name="pvarword"
                                title="In JavaScript change consecutive variable declarations into a comma separated list with a single var keyword."
                                type="radio"/>
                            <label for="pvarword-list">Comma separated list</label>
                        </span>
                        <span>
                            <input id="pvarword-each" name="pvarword"
                                title="In JavaScript change a comma separated list of variables into individual statements each starting with a var keyword."
                                type="radio"/>
                            <label for="pvarword-each">Separate variables</label>
                        </span>
                    </p>
                </fieldset>
            </div>
        ...
        <div id="diffoutput">
            <p id="emailme">Please post comments, feedback, and requests on the

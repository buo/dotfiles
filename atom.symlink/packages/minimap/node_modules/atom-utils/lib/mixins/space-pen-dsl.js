(function() {
  var Builder, Events, Mixin, SelfClosingTags, SpacePenDSL, Tags, Template, _ref,
 ...
 source track wbr'.split(/\s+/).forEach(function(tag) {
  ...
  module.exports = SpacePenDSL = (function(_super) {
    ...
    function SpacePenDSL() {
      _ref = SpacePenDSL.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    SpacePenDSL.includeInto = function(klass) {
      ...
      return Object.defineProperty(klass.prototype, '__create__', {
        enumerable: false,
        value: function() {
    ...
    SpacePenDSL.buildContent = function(element, content) {
      ...
      return this.wireOutlets(element);
    };

    SpacePenDSL.wireOutlets = function(view) {
      var element, outlet, _i, _len, _ref1;
      _ref1 = view.querySelectorAll('[outlet]');
  ...
  Template = (function() {
    ...
    Tags.forEach(function(tagName) {
      return Template.prototype[tagName] = function() {
        ...
        return (_ref1 = this.currentBuilder).tag.apply(_ref1, [tagName].concat(__slice.call(args)));
      };
    });
